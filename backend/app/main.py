...
app.include_router(ias_router, prefix="/api")  # v2 IAS endpoints at /api/v2/ias
app.include_router(eps_router, prefix="/api")  # v2 EPS endpoints at /api/v2/eps
app.include_router(awps_router, prefix="/api")  # v2 AWPS endpoints at /api/v2/awps
app.include_router(crs_router, prefix="/api")  # v2 CRS endpoints at /api/v2/crs
app.include_router(nas_router, prefix="/api")  # v2 NAS endpoints at /api/v2/nas
